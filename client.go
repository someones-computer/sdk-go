...
// APIClient manages communication with the someones.computer API API v1.0.0
...
type APIClient struct {
	...
	AdoptionApprovalAPI *AdoptionApprovalAPIService

	ApplicationAPI *ApplicationAPIService

	CreditTransactionAPI *CreditTransactionAPIService
	...
	ServiceBindingAPI *ServiceBindingAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AdoptionApprovalAPI = (*AdoptionApprovalAPIService)(&c.common)
