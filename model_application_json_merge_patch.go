...
// checks if the ApplicationJsonMergePatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationJsonMergePatch{}

// ApplicationJsonMergePatch A deployable \"island\": one logical app, defined by a compose file, deployed as a swarm stack. Holds a pointer to the current (immutable) deployment; history lives in the deployment revisions.
type ApplicationJsonMergePatch struct {
...
func NewApplicationJsonMergePatch() *ApplicationJsonMergePatch {
	this := ApplicationJsonMergePatch{}
...
func (o *ApplicationJsonMergePatch) SetCurrentDeploymentNil() {
...
func (o *ApplicationJsonMergePatch) SetFirstRunningAtNil() {
...
func (o *ApplicationJsonMergePatch) SetPrimaryDeploymentNameNil() {
...
func (o *ApplicationJsonMergePatch) SetLegacyStackBaseNil() {
...
func (o *ApplicationJsonMergePatch) SetIconKeyNil() {
	o.IconKey.Set(nil)
}
...
func (o *ApplicationJsonMergePatch) SetIconSourceNil() {
...
func (o *ApplicationJsonMergePatch) SetBuildBucketNil() {
...
func (o *ApplicationJsonMergePatch) SetBuildKeyIdNil() {
...
func (o *ApplicationJsonMergePatch) SetPoolDomainNil() {
...
func (o *ApplicationJsonMergePatch) SetPoolLabelNil() {
	o.PoolLabel.Set(nil)
}
...
func (o *ApplicationJsonMergePatch) SetDeletedAtNil() {
	o.DeletedAt.Set(nil)
}
...
func (o *ApplicationJsonMergePatch) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o *ApplicationJsonMergePatch) SetIconNil() {
	o.Icon.Set(nil)
}
...
func (o *ApplicationJsonMergePatch) SetIconVersionNil() {
...
func (o ApplicationJsonMergePatch) MarshalJSON() ([]byte, error) {
...
func (o ApplicationJsonMergePatch) ToMap() (map[string]interface{}, error) {
...
type NullableApplicationJsonMergePatch struct {
	value *ApplicationJsonMergePatch
	isSet bool
}

func (v NullableApplicationJsonMergePatch) Get() *ApplicationJsonMergePatch {
	return v.value
}

func (v *NullableApplicationJsonMergePatch) Set(val *ApplicationJsonMergePatch) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationJsonMergePatch) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationJsonMergePatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationJsonMergePatch(val *ApplicationJsonMergePatch) *NullableApplicationJsonMergePatch {
	return &NullableApplicationJsonMergePatch{value: val, isSet: true}
}

func (v NullableApplicationJsonMergePatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationJsonMergePatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
